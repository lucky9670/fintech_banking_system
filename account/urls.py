...
urlpatterns = [
    ...
    path('whitelabel_client', views.WhiteLabelManager, name = 'whitelabel_client'),
    path('super_distributer', views.SuperDistributor, name = 'super_distributer'),
    path('distributer', views.Distributor, name = 'distributer'),
